...
echo '<thead>';
echo '<tr>';
echo '<th scope="col">'._('P').'</th>';
echo '<th scope="col">'._('Name').'</th>';
echo '<th scope="col">'._('AL').'</th>';
...
echo '</tbody>';
echo '</table>';
echo '<p><strong>'._('Überschriften:').'</strong> '._('P: Position, AL: Alter').'</p>';
echo '<p><strong>'._('Positionen:').'</strong> '._('T: Torwart, A: Abwehr, M: Mittelfeld, S: Sturm').'</p>';
?>
<?php
