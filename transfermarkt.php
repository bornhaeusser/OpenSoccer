<?php include 'zz1.php'; ?>
<title><?php echo _('Transfermarkt | Kaufen | Ausland'); ?> - <?php echo CONFIG_SITE_NAME; ?></title>
<?php include 'zz2.php'; ?>
...
<h1><?php echo _('Transfermarkt | Kaufen | Ausland'); ?></h1>
<?php
...
?>
<table>
<thead><tr class="odd"><th scope="col"><?php echo _('P').'</th><th scope="col">'._('Spieler').'</th><th scope="col">'._('AL').'</th><th scope="col">'._('ST').'</th><th scope="col">'._('Gebot').'</th><th scope="col">'._('Noch'); ?></th></tr></thead>
<tbody>
<?php
...
<p><strong><?php echo _('Überschriften:').'</strong> '._('P: Position, AL: Alter, ST: Stärke (Talent)'); ?></p>
