...
<p>
    ...
    <a target="_blank" title="WhatsApp" href="whatsapp://send?text=<?php echo urlencode('http://'.CONFIG_SITE_DOMAIN.'/index.php?r='.$cookie_id); ?>">
        <img alt="WhatsApp" src="/images/brands/whatsapp-32.png" width="32" />
    </a>
</p>
