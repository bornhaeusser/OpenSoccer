    ...
    <div id="wrap">
        ...
        ?>>
            <div class="logo_top" style="padding:12px 0;"><img src="/images/logo.png" alt="<?php echo CONFIG_SITE_NAME; ?> - <?php echo _('Online-Fußball-Manager'); ?>" title="<?php echo CONFIG_SITE_NAME; ?> - <?php echo _('Online-Fußball-Manager'); ?>" width="224" style="display:block; border:0; width:224px; height:60px; margin:0 auto;" />
                <?php
                $topWidget = '<h1>'._('Top-Manager').' (<a href="/top_manager.php">'._('Alle').'</a>)</h1>';
...
// LIGA-TAUSCH-ANFRAGEN ENDE
    ...
    <?php if ($cookie_team != '__' . $cookie_id) { ?>
                    ...
                    <li class="menueintrag"<?php
                        ...
                        <ul>
                            <li><a href="/transfermarkt.php"><?php echo _('Kauf | Ausland'); ?></a></li>
							<li><a href="/transfermarkt_leihe.php"><?php echo _('Kauf | Leihe'); ?></a></li>
    <?php if ($cookie_team != '__' . $cookie_id) { ?><li><a href="/beobachtung.php"><?php echo _('Beobachtung'); ?></a></li><?php } ?>
                ...
                ?>><a href="/lig_tabelle.php"><?php echo _('Saison'); ?></a>
                        <ul>
                            ...
                            <li><a href="/pokal.php"><?php echo _('Internat. Pokal'); ?></a></li>
							<li><a href="/cup.php"><?php echo _('Nationaler Cup'); ?></a></li>
                    ...
                    ?>><a href="/ver_finanzen.php"><?php echo _('Verein'); ?></a>
                        <ul>
                            ...
                            <li><a href="/ver_settings.php"><?php echo _('Wappen'); ?></a></li>
                    ...
                    <li class="menueintrag"<?php
                        ...
                        <ul>
                            <li><a href="/leihgaben.php"><?php echo _('Transfers'); ?> (<?php echo $_SESSION['last_leihgaben_anzahl']; ?>)</a></li>
...
if ($laufende_spiele3 != 0) {
	echo '<h1>'._('LIVE-Zentrale').' (<a href="/liveZentrale.php">'._('LIVE').'</a>)</h1>';
	echo '<div class="left-box"><p>';
	echo 'Es finden gerade '.$live_scoring_spieltyp_laeuft.'-Spiele statt.';
	echo '</p></div>';
}
...
<?php if ($cookie_team != '__' . $cookie_id) { ?>
<?php
$nextGamesHTML = '<h1>'._('Nächste Spiele').' (<a href="/kalender.php">'._('Alle').'</a>)</h1><div class="left-box navBlockLinks matchList">';
...
<?php } ?>
<?php
// show random changlog
echo '<h1>'._('Änderungen').' (<a href="/aenderungen.php">'._('Alle').'</a>)</h1>';
echo '<div class="left-box"><p>';
$changelog = file('aenderungen.php.txt');
// ignore the first line (PHP tag)
$randomHintIndex = mt_rand(1, count($changelog)-1);
// be careful with the input for eval() here (which should only contain a gettext call)
$randomHint = eval($changelog[$randomHintIndex]);
echo $randomHint;
echo '</p></div>';
?>
                </div>
