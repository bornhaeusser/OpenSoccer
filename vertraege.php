...
$sql1 = "SELECT ids, vorname, nachname, wiealt, marktwert, gehalt, vertrag, leiher, moral, staerke, talent, position FROM ".$prefix."spieler WHERE team = '".$cookie_team."' ORDER BY vertrag ASC";
...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	echo '<td>'.floor(($sql3['vertrag']-time())/86400).'</td>';
...
<p><strong><?php echo _('Überschriften:').'</strong> '._('P: Position, AL: Alter, MO: Moral, ST: Stärke/Talent, VT: Vertragsdauer in Tagen, GE: Gehalt pro Saison in Millionen €'); ?></p>
<?php } else { ?>
